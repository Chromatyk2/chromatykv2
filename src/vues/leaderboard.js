                        ...
                        <div class={"leaderboardHeaderContainer"}>
                            ...
                            <div style={{width: "92%",display: "flex",justifyContent: "space-between"} }>
                                <div className={"profilHeader"}>
                                    <div style={{ width: "40px", height: "40px", backgroundColor: color, backgroundImage: `url("/Skins/Trainer${val.skin}.png")`, backgroundRepeat: "no-repeat", backgroundSize: "contain", backgroundPosition: "center" }} className={"profilPicture"}>
                                    </div>
                                ...
                                {val.number !== null &&
                                    <div className={"profilHeader"}>
                                        ...
                                        <div style={{ width: "40px", height: "40px", filter: val.negative === 1 ? "invert(1)" : "invert(0)", backgroundColor: color, backgroundImage: `url("/Sprites/${val.shiny === 1 ? "Shiny" : "Normal"}/${val.number}.gif")`, backgroundRepeat: "no-repeat", backgroundSize: "contain", backgroundPosition: "center" }} className={"compagnonPicture"}>
                                        </div>
                                        {/*<img className={"profilPicture"} style={{ background: color }} src={"/Skins/Trainer"+profil[0].skin+".png"} />*/}
                                    </div>
                                }
